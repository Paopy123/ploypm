...
export const PIN_GATE_TITLE = 'Every moment with Ploypm';
export const PIN_GATE_SUBTITLE = 'Enter the code only you would know';

export const SITE_TITLE = 'Every moment with Ploypm';
...
export const LETTER_MESSAGE = `Ploypm,
...
export const FOOTER_TEXT = 'just for ploy.';
